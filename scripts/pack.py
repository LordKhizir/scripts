...
os.system("dot_clean .")
os.system('find . \( -name ".DS_Store" -or -name "Thumbs.db" -or -name "desktop.ini" \) -delete ')

for entry in os.scandir("."):
    if entry.is_dir() and False:
        os.system('7za a -t7z -m0=lzma2 -mx=9 -mqs=on -mfb=64 -md=1024m -ms=on ' +
